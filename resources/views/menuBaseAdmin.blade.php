...
@section('content')
@vite(['resources/css/style.css','resources/js/bootstrap.js','resources/js/main.js'])
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a  id="carga-link" class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="{{ route('semestres') }}">
