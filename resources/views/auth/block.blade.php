    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            ...
            <a class="navbar-brand ml-3" href="<?php echo e(url('/')); ?>">
                <h3>Escuela de informática</h3> </a>
...
<form method="POST" action="{{ route('actualizar.nombre') }}">
    @csrf

    <div class="mb-3">
        <label for="nuevoNombre" class="form-label">Nuevo Nombre</label>
        <input type="text" class="form-control" id="nuevoNombre" name="nuevoNombre" value="{{ old('nuevoNombre') }}" required>
    </div>
